...
export const Hero = () => {
    ...
    return (
        <motion.div
            ...
            className="w-full max-w-6xl bg-white/90 dark:bg-[#0A0A0A] backdrop-blur-xl rounded-[2.5rem] p-6 sm:p-8 shadow-2xl dark:shadow-[0_0_80px_-15px_rgba(255,255,255,0.1)] border border-gray-200 dark:border-white/10 relative overflow-hidden group"
        >
            {/* Top Section: Profile & Handle */}
            <div className="flex justify-between items-start mb-6">
                <div className="flex gap-4 items-center">
                    <div className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-full overflow-hidden border-2 border-gray-200 dark:border-white/10 shadow-inner">
                        <Image
                            src={Guts}
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="p-3 rounded-2xl bg-gray-50 dark:bg-zinc-900 border border-gray-100 dark:border-white/5 text-gray-900 dark:text-white shadow-sm hover:shadow-md transition-all duration-300"
                >
            ...
            <div className="space-y-3 mb-6">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-gray-900 dark:text-white h-[1.2em] flex items-center">
                    I build&nbsp;
                ...
                <p className="text-gray-600 dark:text-gray-300 text-lg sm:text-xl leading-relaxed max-w-2xl">
                ...
                {links.map((link) => (
                    <div key={link.id} className="relative">
                        <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-12 h-12 rounded-2xl flex items-center justify-center bg-gray-50/80 dark:bg-zinc-900/80 border border-gray-100 dark:border-white/5 hover:bg-white dark:hover:bg-zinc-800 transition-all duration-300 shadow-sm"
                        >
            ...
            <div className="flex flex-wrap items-center justify-between gap-6">
                ...
                >
                    <button className="px-6 py-3 rounded-2xl flex items-center justify-center gap-2 text-sm font-semibold transition-all duration-300 bg-gray-900 text-white hover:bg-gray-800 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100 shadow-lg active:scale-95">
                ...
                <div className="flex flex-col items-end">
                    <div className="text-gray-500 dark:text-gray-400 text-xs font-mono tracking-tight opacity-70 mb-1">
                        {formatDateTime(time)}
                    </div>
